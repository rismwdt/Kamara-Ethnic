<aside class="hidden lg:block fixed top-16 left-0 h-screen w-48 lg:w-64 bg-white border-r border-gray-200 z-30">
    <div>
        ...
        <nav class="mb-5 mt-6 pl-8 pr-8 text-sm font-medium">
            ...
            <x-nav-link :href="route('pengaturan-pengisi-acara.index')"
                :active="request()->routeIs('admin.pengaturan-pengisi-acara.*')"
                class="flex items-center space-x-3 py-2 px-4 w-full hover:bg-gray-100">
                <i class="fas fa-cogs text-gray-500"></i>
                <span>{{ __('Pengaturan Pengisi Acara') }}</span>
            </x-nav-link>
            ...
            <x-nav-link :href="route('admin.rekap-pengisi-acara')"
                :active="request()->routeIs('admin.rekap-pengisi-acara')"
                class="flex items-center space-x-3 py-2 px-4 w-full hover:bg-gray-100">
                <i class="fas fa-chart-bar text-gray-500"></i>
                <span>{{ __('Rekap Pengisi Acara') }}</span>
            </x-nav-link>
