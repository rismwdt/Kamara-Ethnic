...
<x-modal name="modal-jadwal-bentrok" focusable>
    <div class="p-6 relative">
        ...
        <p class="text-gray-700 mb-2">
            Mohon maaf, tanggal dan waktu yang Anda pilih
            <span id="jadwal-bentrok-picked" class="font-semibold"></span> tidak tersedia.
        </p>
        <p id="jadwal-bentrok-reason" class="text-sm text-red-600 mb-4"></p>

        <div class="mb-2 text-gray-800 font-medium">Pilihan waktu alternatif (hari yang sama):</div>
        <ul id="jadwal-alternatif-list" class="list-disc list-inside space-y-1 text-gray-700 mb-4">
            {{-- diisi via JS --}}
        </ul>
        <p class="text-xs text-gray-500 mb-4">*Klik salah satu waktu untuk mengisi form otomatis.</p>
            ...
            <div class="flex flex-wrap gap-2">
                <template x-for="opt in types" :key="opt.value">
                    <button type="button"
                            ...
                            :class="type === opt.value ? 'bg-white text-primary border-gray-900' : 'bg-white hover:bg-gray-50 border-gray-300'"
                            x-text="opt.label"
