    ...
    <div class="container">
        <div class="w-full px-4">
            <div class="max-w-xl mx-auto text-center mb-16">
                ...
                <h2 class="font-bold text-dark text-3xl mb-4 md:text-4xl lg:text-5xl">
                    Paket Acara Kamara Ethnic
                </h2>
                <p class="font-medium text-md text-secondary md:text-lg">
                    Kami menyediakan berbagai paket pertunjukan seni tradisional khas Sunda yang memeriahkan momen spesial Anda.
                </p>
            </div>
                    ...
                    <div x-data="{ open: false }" class="flex flex-col bg-white rounded-3xl shadow-lg overflow-hidden p-4">
                        ...
                        @auth
                            <button
                                ...
                                data-price="{{ (int) $event->price }}"
                                {{-- opsional prefill jadwal: biarkan kosong jika tidak dipakai --}}
                                data-date=""
                                data-start=""
                                data-end="">
                                Pesan Sekarang
