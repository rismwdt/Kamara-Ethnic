            ...
            <div class="flex flex-col md:flex-row gap-4">
                <div class="w-full md:w-1/2 space-y-4">
                    ...
                    <div>
                        ...
                        <select id="gender" name="gender" class="mt-1 block w-full rounded border-gray-300 shadow-sm"
                            ...
                            <option value="laki-laki"
                                {{ old('gender', $performer->gender) === 'laki-laki' ? 'selected' : '' }}>Laki-laki
                            </option>
                            <option value="perempuan"
                                {{ old('gender', $performer->gender) === 'perempuan' ? 'selected' : '' }}>Perempuan
                            </option>
                            <option value="lainnya"
                                {{ old('gender', $performer->gender) === 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                        </select>
                    ...
                    <div>
                        ...
                        <select id="performer_role_id" name="performer_role_id"
