        ...
        <div class="bg-white shadow rounded-lg p-6 text-gray-800">
            <table class="table-auto w-full text-sm text-left text-gray-700">
                <tbody class="divide-y divide-gray-200">
                    <tr><th class="py-2 pr-4 font-medium w-1/3">Kode Pesanan</th><td>: {{ $booking->booking_code }}</td></tr>
                    <tr><th class="py-2 pr-4 font-medium">Paket Acara</th><td>: {{ $booking->event->name }}</td></tr>
                    <tr><th class="py-2 pr-4 font-medium">Nama Klien</th><td>: {{ $booking->client_name }}</td></tr>
                    <tr><th class="py-2 pr-4 font-medium">No. HP</th><td>: {{ $booking->phone }}</td></tr>
                    <tr><th class="py-2 pr-4 font-medium">Email</th><td>: {{ $booking->email }}</td></tr>
                    <tr><th class="py-2 pr-4 font-medium">Orang Tua Pria</th><td>: {{ $booking->male_parents }}</td></tr>
                    <tr><th class="py-2 pr-4 font-medium">Orang Tua Wanita</th><td>: {{ $booking->female_parents }}</td></tr>
                    <tr><th class="py-2 pr-4 font-medium">Nuansa Acara</th><td>: {{ $booking->nuance }}</td></tr>
                    <tr><th class="py-2 pr-4 font-medium">Tanggal</th><td>: {{ \Carbon\Carbon::parse($booking->date)->format('d-m-Y') }}</td></tr>
                    <tr><th class="py-2 pr-4 font-medium">Waktu</th>
                    ...
                    <tr><th class="py-2 pr-4 font-medium">Alamat Lengkap</th><td>: {{ $booking->location_detail }}</td></tr>
                    <tr><th class="py-2 pr-4 font-medium">Catatan</th><td>: {{ $booking->notes }}</td></tr>
                    <tr>
